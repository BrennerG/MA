...
PARAMS = {
    ...
    'lime_num_permutations': 10, # number of input permutations per sample; default=5k :O
    ...
    'save_loc': 'data/experiments/curious-darkness_notrain_lime_perm=10/', # location where the above are saved
