...
PARAMS = {
    ...
    #'load_from': 'data/experiments/bert10/checkpoint-5470', # use a checkpoint (currently only for inference) train from pretrained base if empty
    ...
    'bert_base': 'roberta-base', # choose the pretrained bert-base
    ...
    'save_loc': 'data/experiments/roberta10_lr=5e-5/', # location where the above are saved
